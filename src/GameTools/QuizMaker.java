...
public class QuizMaker {
    ...
    QuizMaker() {
        ...
        switch (range) {
            ...
            case 3:
                ...
                break;
            default:
                System.out.println("Please enter the number (1 ~ 3)");
                System.exit(0);
        }
    ...
    //		---- > beens < ----
    public int getquizRange() {
        return this.quizRange;
    }
    ...
    public void setquizRange(int quizRange) {
